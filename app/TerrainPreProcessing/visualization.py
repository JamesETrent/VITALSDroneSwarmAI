...
def plot_postGIS_data(rtree_index, grid = None, search_points = [], colors = {}, show_grid = True, polygon_darkening_factor = 0.5):
    """
    ...
    ax = gdf.plot(color=gdf["color_hex"], figsize=(10, 6), edgecolor="black", alpha=1)
    ax.set_title("Blended Colors for Mixed Categories")
    ...
    if grid and show_grid:
        ...
        for i in range(len(grid)):
            for j in range(len(grid)):
                ...
                ax.fill(x, y, edgecolor='black', facecolor=tile_color, alpha=0.75, linewidth=1)
    ...
    if search_points and show_grid:
        ...
        new_polygon_gdf.plot(ax=ax, edgecolor="black", facecolor="none", alpha=1, linewidth = 3)
